...
<title>Customer Rental View</title>
</head>
...
<div class="w3-container">
	<div class="w3-card-4 w3-red">
		<div class="w3-display-container" style="height:300px;">
			<div class="w3-display-left" style="height:300px;">
				<form action="CyberFlixCustomerRentalResultsServlet" method="get">
					View Customer Rental Record By ID: 
